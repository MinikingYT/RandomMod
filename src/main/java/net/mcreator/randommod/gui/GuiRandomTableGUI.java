...
package net.mcreator.randommod.gui;
...
public class GuiRandomTableGUI extends ElementsRandomMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiRandomTableGUI(ElementsRandomMod instance) {
		super(instance, 6);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 134, 30) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				RandomMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("randommod:textures/randomtablegui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("randommod:textures/craft-arrow.png"));
			this.drawTexturedModalRect(this.guiLeft + 92, this.guiTop + 35, 0, 0, 256, 256);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 73, this.guiTop + 46, 50, 20, "Craft"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			RandomMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
